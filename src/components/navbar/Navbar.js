...
export const Navbar = () => {
  ...
  return (
    <>
    <div className='bigNavBarDiv'>
        {/* Menu Icon */}
        <div
          className='bg-white w-16 h-16 rounded-full mt-8 flex items-center justify-center cursor-pointer menuIcon'
        ...
        >
          <div className='text-black p-4'>
            {/* Close Button */}
            <div className='flex justify-start mt-10 ml-11'>
            ...
            <ul>
              ...
              <li className='mb-8 flex justify-center text-black text-4xl font-thin tracking-widest transform transition-transform duration-700 hover:scale-[1.2]'><a href='#'>About</a></li>
